// frontend/src/pages/admin/AddProduct.jsx - WITH MULTIPLE IMAGE SUPPORT
...
const AddProduct = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        bestSeller: false,
        status: 'PUBLISHED',
        variants: [{ weight: '', unit: 'GM', mrp: '', sellingPrice: '', stock: '' }]
    });
                            ...
                            {formData.images.map((image, index) => (
                                <div key={index} className="relative group">
                                    <img
                                        ...
                                        className={`w-full h-32 object-cover rounded-xl border-2 ${image.isPrimary ? 'border-primary-maroon' : 'border-secondary-gold/20'
                                            }`}
                                    />
                                    {image.isPrimary && (
