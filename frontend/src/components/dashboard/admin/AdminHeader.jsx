// 🔵 FRONTEND: src/components/dashboard/admin/AdminHeader.jsx
      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-4">
          <Link to="/admin/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-heading text-xl font-bold text-secondary-gold">Admin</span>
          </Link>
          <span className="hidden md:inline-block px-3 py-1 bg-primary-maroon/10 text-primary-maroon text-xs font-button font-medium rounded-full">
            {role}
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/admin/settings" className="p-2 rounded-full hover:bg-background-cream transition-colors">
